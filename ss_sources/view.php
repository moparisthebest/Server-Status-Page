...
<table class="<?php echo ($spons == 0) ? 'other' : 'spons'; ?>" summary="<?php echo $name; ?>">
    ...
    <tr>
        ...
        <th scope="row" colspan="3"><a href="<?php echo $this_url; ?>"><img src="<?php echo $status_img_url; ?>"
                                                                            alt="Status Image"/></a></th>
        <th scope="row">BBcode:<br/><a href="javascript:void(0);" onclick="return selectText();">[Select]</a></th>
        <th scope="row" colspan="<?php echo ((can_mod() && $spons == 0) ? '5' : '4'); ?>">
            <div id="selectme">[url=<?php echo $this_url; ?>][img]<?php echo $status_img_url; ?>[/img][/url]</div>
        </th>
    </tr>
    </tfoot>
