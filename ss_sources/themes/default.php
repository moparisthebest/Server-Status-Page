...
<div id="wrapper">
    <div id="header">
        <div id="lefthead"> <a href="<?php echo $g_theme['left_link']; ?>"><img src="<?php echo $g_img_dir; ?>/left.png" alt="<?php echo $g_theme['left_link_alt']; ?>" /></a> </div>
        <div id="righthead"> <a href="<?php echo $g_theme['right_link']; ?>"><img src="<?php echo $g_img_dir; ?>/right.png" alt="<?php echo $g_theme['right_link_alt']; ?>" /></a> </div>
        <div id="banner"> <a href="<?php echo $g_theme['center_link']; ?>"><img src="<?php echo $g_img_dir; ?>/center.png" alt="<?php echo $g_theme['center_link_alt']; ?>" /></a> </div>
  ...
  <div id="rightcolumn">
    ...
    <div id="footer">
        <p>
            ...
            <a style="color: black;" class="black" href="http://www.gnu.org/licenses/agpl-3.0.html">Copyright &copy; 2009-2012</a>,
